...
const realProjects = [
  {
    ...
    period: "Jun 2026",
    description: "A live, full-stack exam platform built in one week with self-enrollment, auto-generated roll numbers, and a timed 180-question exam engine with negative marking. Includes an anti-cheating system (tab-switch detection, server-enforced time windows, auto-submission), real-time scoring, an automatic merit list, and a digital certificate system with an admin panel.",
    tech: ["Next.js", "TypeScript", "PostgreSQL", "Vercel"],
    imagePath: "/ats-mdcat.jpg",
